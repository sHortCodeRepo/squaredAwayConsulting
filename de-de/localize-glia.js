// This function sets the Glia locale to German.
function setGliaLocaleGerman() {
  ...
  if (typeof sm !== 'undefined' && sm.getApi) {
    sm.getApi({version: 'v1'}).then(function(api){
      ...
      // Note: The standard IETF format is 'de-DE'. 
      // Using 'deutsch' as specifically requested.
      api.setLocale('deutsch');
      console.log("Glia locale set to deutsch.");
    });
  } else {
...
setTimeout(setGliaLocaleGerman, 2000); // Wait 2 seconds before executing.
