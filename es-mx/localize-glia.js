// This function sets the Glia locale to Mexican Spanish.
function setGliaLocaleSpanishMX() {
  ...
  if (typeof sm !== 'undefined' && sm.getApi) {
    sm.getApi({version: 'v1'}).then(function(api){
      ...
      // Note: The standard IETF format is 'es-MX'. 
      // Using 'espanolmexicano' as specifically requested.
      api.setLocale('espanolmexicano');
      console.log("Glia locale set to espanolmexicano.");
    });
  } else {
...
setTimeout(setGliaLocaleSpanishMX, 2000); // Wait 2 seconds before executing.
